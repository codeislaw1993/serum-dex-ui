          ...
          _autoSize: function (t) {
            ...
            this._get(t, 'autoSize') &&
              ...
              i.match(/[DM]/) &&
                ...
                e.setDate(
                  s(
                    this._get(t, i.match(/DD/) ? 'dayNames' : 'dayNamesShort'),
                  ) +
                    20 -
                    e.getDay(),
                )),
              ...
              switch (t.keyCode) {
                ...
                case 33:
                  $.datepicker._adjustDate(
                    t.target,
                    t.ctrlKey
                      ? -$.datepicker._get(i, 'stepBigMonths')
                      : -$.datepicker._get(i, 'stepMonths'),
                    'M',
                  );
                  break;
                case 34:
              ...
              s =
                ...
                g = function (t, i, s) {
                  ...
                  for (n = 0; n < o.length; n++)
                    if (
                      e.substr(_, o[n].length).toLowerCase() ==
                      o[n].toLowerCase()
                    )
            ...
            for (
              t.drawMonth = d,
                ...
                g = n
                  ? this.formatDate(
                      g,
                      this._daylightSavingAdjust(new Date(u, d - a, 1)),
              ...
              for (H = '', Y = 0; Y < o[1]; Y++) {
                    ...
                    switch (Y) {
                      case 0:
                        (F += ' ui-datepicker-group-first'),
                          (E = ' ui-corner-' + (e ? 'right' : 'left'));
                        break;
                      case o[1] - 1:
                        (F += ' ui-datepicker-group-last'),
                          (E = ' ui-corner-' + (e ? 'left' : 'right'));
                        break;
                      default:
                ...
                for (
                  ...
                  for (
                    ...
                    (J = C
                      ? C.apply(t.input ? t.input[0] : null, [Q])
                      : [!0, '']),
                      (Z = Q.getMonth() != d),
              ...
              (n = u.snapElements[s].left),
                ...
                (n - g < _ && _ < o + g && r - g < b && b < a + g)
                  ? ('inner' != f.snapMode &&
                      ...
                      h &&
                        (i.position.top =
                          u._convertPositionTo('relative', {
                            top: r - u.helperProportions.height,
                            left: 0,
                          }).top - u.margins.top),
                      l &&
                        (i.position.top =
                          u._convertPositionTo('relative', { top: a, left: 0 })
                            .top - u.margins.top),
                      c &&
                        (i.position.left =
                          u._convertPositionTo('relative', {
                            top: 0,
                            left: n - u.helperProportions.width,
                          }).left - u.margins.left),
                      p &&
                        (i.position.left =
                          u._convertPositionTo('relative', { top: 0, left: o })
                            .left - u.margins.left)),
                    (d = h || l || c || p),
                    'outer' != f.snapMode &&
                      ((h = Math.abs(r - v) <= g),
                      ...
                      h &&
                        (i.position.top =
                          u._convertPositionTo('relative', { top: r, left: 0 })
                            .top - u.margins.top),
                      l &&
                        (i.position.top =
                          u._convertPositionTo('relative', {
                            top: a - u.helperProportions.height,
                            left: 0,
                          }).top - u.margins.top),
                      c &&
                        (i.position.left =
                          u._convertPositionTo('relative', { top: 0, left: n })
                            .left - u.margins.left),
                      p &&
                        (i.position.left =
                          u._convertPositionTo('relative', {
                    ...
                    !u.snapElements[s].snapping &&
                      ...
                      u.options.snap.snap.call(
                        ...
                        e,
                        t.extend(u._uiHash(), {
                          snapItem: u.snapElements[s].item,
                        }),
                      ),
        ...
        _updateRatio: function (t, e) {
          ...
          return (
            t.height
              ...
              : t.width && (t.height = s.width / this.aspectRatio),
            'sw' == n &&
        ...
        t.ui.plugin.add('resizable', 'containment', {
          ...
          resize: function (e, i) {
            ...
            u[0] != document && f && (d = l),
              ...
              (s = Math.abs(
                (a._helper, a.offset.left - d.left + a.sizeDiff.width),
              )),
              (n = Math.abs(
                (a._helper ? a.offset.top - d.top : a.offset.top - l.top) +
                  a.sizeDiff.height,
              )),
              ...
              s + a.size.width >= a.parentData.width &&
                ...
                p && (a.size.height = a.size.width / a.aspectRatio)),
              n + a.size.height >= a.parentData.height &&
                ((a.size.height = a.parentData.height - n),
                p && (a.size.width = a.size.height * a.aspectRatio));
          },
          stop: function (e, i) {
            var s = t(this).data('resizable'),
              n = s.options,
        ...
        t.ui.plugin.add('resizable', 'grid', {
          resize: function (e, i) {
            ...
            (r.grid = 'number' == typeof r.grid ? [r.grid, r.grid] : r.grid),
              (s =
                Math.round((a.width - h.width) / (r.grid[0] || 1)) *
                (r.grid[0] || 1)),
              (n =
                Math.round((a.height - h.height) / (r.grid[1] || 1)) *
                (r.grid[1] || 1)),
              /^(se|s|e)$/.test(c)
    ...
    !(function (t, e) {
      t.widget('ui.sortable', t.ui.mouse, {
        ...
        _removeCurrentsFromItems: function () {
          ...
          for (t = 0; t < this.items.length; t++)
            for (e = 0; e < i.length; e++)
              i[e] == this.items[t].item[0] && this.items.splice(t, 1);
        },
                ...
                (h = t.data(r[a], 'sortable')) &&
                  ...
                  (s.push([
                    t.isFunction(h.options.items)
                      ? h.options.items.call(h.element[0], e, {
                          item: this.currentItem,
                        })
            ...
            (n.placeholder = {
              element: function () {
                var e = t(document.createElement(s.currentItem[0].nodeName))
                  .addClass(
                    i ||
                      s.currentItem[0].className + ' ui-sortable-placeholder',
                  )
        ...
        _contactContainers: function (e) {
          ...
          for (i = this.containers.length - 1; i >= 0; i--)
            if (
              !t.ui.contains(this.currentItem[0], this.containers[i].element[0])
            )
              if (this._intersectsWith(this.containers[i].containerCache)) {
                if (
                  h &&
                  t.ui.contains(this.containers[i].element[0], h.element[0])
                )
                  continue;
            ...
            if (1 === this.containers.length)
              ...
              for (
                s = 1e4,
                  n = null,
                  o = this.positionAbs[
                    this.containers[l].floating ? 'left' : 'top'
                  ],
          ...
          return (
            ...
            this.originalPosition &&
              ...
              r.grid &&
                ...
                (o =
                  this.originalPageX +
                  Math.round((i - this.originalPageX) / r.grid[0]) * r.grid[0]),
                (i =
                  this.containment &&
