webpackJsonp([5], {
  ...
  208: function (e, t, o) {
    ...
    var a = o(10),
      ...
      g = o(46).addColorPicker,
      w = o(31).createLineStyleEditor,
      T = o(1123).createShapeLocationEditor,
      _ = o(1124).createShapeStyleEditor,
      m = o(15).createLineWidthEditor,
      f = o(1125).createVisibilityEditor,
      L = o(1121).createHHistDirectionEditor,
      ...
      (i.prototype.prepareLayout = function () {
        ...
        this.addOneColorPropertyWidget(this._table),
          ...
          this._linetool.properties().reverse &&
            ...
            (P = $('<label>').append(E).append($.t('Reverse'))),
            $('<td>').append(P).appendTo(k)),
          (R = $('<tr>').appendTo(v)),
          (F = $("<input type='checkbox' class='visibility-switch'>")),
          ...
          $('<td>').append(P).appendTo(R),
          (A = $("<input type='checkbox' class='visibility-switch'>")),
          (P = $('<label>').append(A).append($.t('Percents'))),
          $('<td>').append(P).appendTo(R),
    ...
    inherit(i, a),
      (i.prototype.prepareLayout = function () {
        ...
        (this._res = $('<div>')),
          ...
          $('<td>').append(w).appendTo(i),
          $("<td colspan='3'>").append(T).appendTo(i),
  ...
  406: function (e, t, o) {
    (function (t) {
      ...
      var n = o(10),
        ...
        g = o(1122).createPriceSourceEditor,
        w = o(38).NumericFormatter;
      inherit(i, a),
        ...
        (i.prototype._prepareSeriesStyleLayout = function (e, o, i, n) {
          ...
          nt.addClass('property-wide-select'),
            ...
            $('<td colspan="3">').append(z).appendTo(P),
            ...
            $('<td colspan="3">').appendTo(P).append(Ee),
            this.bindControl(
              new h(
                Ee,
      ...
      inherit(i, l),
        ...
        (i.prototype.prepareLayout = function () {
          ...
          if (
            (t.enabled('chart_property_page_style') &&
              ...
              (W = f()),
              $('<td colspan="2">').append(W).appendTo(A),
              this.bindControl(
                new b(
                  W,
            ...
            t.enabled('chart_property_page_background') &&
              ...
              $('<td colspan="2">').append(Ne).appendTo(Ge),
              this.bindControl(
                new u(
                  Ne,
              ...
              (Ke = m()),
              $('<td colspan="2">').append(Ke.render()).appendTo(Ue),
              this.bindControl(
                new C(
                  Ke,
              ...
              (Ze = m()),
              $('<td colspan="2">').append(Ze.render()).appendTo(Qe),
              this.bindControl(
                new C(
                  Ze,
              ...
              $('<td colspan="2">').append(ot).appendTo(it),
              this.bindControl(
                new u(
                  ot,
              ...
              (pt = m()),
              $('<td>').append(pt.render()).appendTo(rt),
              this.bindControl(
                new C(
                  pt,
              ...
              x.append(vt).append(kt).append(St)),
        ...
        (i.prototype.createEventsTable = function (e) {
          ...
          $('<td>').append(j).prependTo(z),
            ...
            $('<td>').append(a).prependTo(z),
            (p = _($('<td>').appendTo(z))),
            $('<td>').append(r.render()).appendTo(z),
            $('<td>').append(l).appendTo(z),
            ...
            t.enabled('alerts') &&
              ...
              $('<td>').append(F).prependTo(z),
              (W = _($('<td>').appendTo(z))),
              $('<td>').append(D).appendTo(z),
              $('<td>').append(I).appendTo(z),
              z.addClass('offset-row'),
              z.append('<td>'),
              this.bindControl(
                new c(
    ...
    inherit(i, n),
      (i.prototype.prepareLayout = function () {
        ...
        (this._block = $('<div>').addClass('property-page')),
          ...
          $('<td colspan="3">').appendTo(a).append(y).append(w),
  ...
  784: function (e, t, o) {
    ...
    inherit(i, n),
      ...
      (i.prototype.prepareLayout = function () {
        ...
        (w = $('<table>')),
          $("<td valign='top'>").append(w).appendTo(e),
          (T = $('<tr>')),
        ...
        this.addOneColorPropertyWidget(L),
          ...
          (E = $('<tr>').appendTo(P)),
          (R = $('<table>')),
          $('<td colspan="3">').append(R).appendTo(E),
          (E = $('<tr>').appendTo(R)),
          $('<td>').append(x).appendTo(E),
          $('<td>' + $.t('Background') + '</td>').appendTo(E),
          $('<td>').append(B).appendTo(E),
          this._linetool.properties().reverse &&
            ((F = $("<input type='checkbox' class='visibility-switch'>")),
            (E = this.addLabeledRow(R, $.t('Reverse'), F, !0)),
            $('<td>').append(F).prependTo(E),
            this.bindControl(
              new r(
                F,
                this._linetool.properties().reverse,
